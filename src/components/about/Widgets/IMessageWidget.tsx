...
const initialPrompt =
  'interested in joining Nexus? want to collaborate? drop us a message here! 🚀';
...
> = {
  contact:
    "awesome! 👀 what's the best way to reach you? (email, Instagram, etc.)",
  extra: 'thanks 🙏 anything else you want to share with us?'
};
...
export default function IMessageWidget() {
  ...
  const finishConversation = () => {
    ...
    try {
      ...
      const mailtoHref = `mailto:nexus.adce@gmail.com?subject=${encodeURIComponent(
        subject
